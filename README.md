...
The proposed method is amenable to efficient algorithms based on partial minimization and naturally adapts to handle maximum-dose constraints and cases of infeasibility.
